<?php
    ...
    if($resultado->num_rows > 0){   
        ...
        while($linha = $resultado->fetch_assoc()){
            ...
            echo "<tr><td>".$linha['codLivro']."</td><td>".$linha['titulo']."</td><td>".$linha['autor']."</td><td>".$linha['genero']."</td><td>".$linha['idioma']."</td><td>"."<button class='botões-editar' type='submit' method='POST' name='id_excluir'>
            ...
            </button>"."<button class='botões-editar' type='submit' method='POST' value='id_excluir'>
